...
func validNewVolumeAttachment(name string) *storageapi.VolumeAttachment {
	...
	return &storageapi.VolumeAttachment{
		...
		Spec: storageapi.VolumeAttachmentSpec{
			...
			AttachedVolumeSource: storageapi.AttachedVolumeSource{
...
func TestCreate(t *testing.T) {
	if *testapi.Storage.GroupVersion() != storageapiv1.SchemeGroupVersion {
		// skip the test for v1beta1 and older
		return
	}
