...
func TestMakeMounts(t *testing.T) {
	...
	mounts, _ = makeMounts(&pod, "/pod", &container, "fakepodname", "", "", podVolumes, false /* enableMountPropagation */)
	...
	assert.Equal(t, expectedPrivateMounts, mounts, "mounts of container %+v", container)
