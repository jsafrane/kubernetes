...
// isCSIDriverInstalled returns a boolean indicating if the given CSI driver is installed on the node.
func isCSIDriverInstalled(csiNode *storagev1beta1.CSINode, driverName string) bool {
