...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		Convert_v1_AttachedVolumeSource_To_storage_AttachedVolumeSource,
		Convert_storage_AttachedVolumeSource_To_v1_AttachedVolumeSource,
...
func autoConvert_v1_AttachedVolumeSource_To_storage_AttachedVolumeSource(in *v1.AttachedVolumeSource, out *storage.AttachedVolumeSource, s conversion.Scope) error {
	out.PersistentVolumeName = (*string)(unsafe.Pointer(in.PersistentVolumeName))
	return nil
}

// Convert_v1_AttachedVolumeSource_To_storage_AttachedVolumeSource is an autogenerated conversion function.
func Convert_v1_AttachedVolumeSource_To_storage_AttachedVolumeSource(in *v1.AttachedVolumeSource, out *storage.AttachedVolumeSource, s conversion.Scope) error {
	return autoConvert_v1_AttachedVolumeSource_To_storage_AttachedVolumeSource(in, out, s)
}

func autoConvert_storage_AttachedVolumeSource_To_v1_AttachedVolumeSource(in *storage.AttachedVolumeSource, out *v1.AttachedVolumeSource, s conversion.Scope) error {
	out.PersistentVolumeName = (*string)(unsafe.Pointer(in.PersistentVolumeName))
	return nil
}

// Convert_storage_AttachedVolumeSource_To_v1_AttachedVolumeSource is an autogenerated conversion function.
func Convert_storage_AttachedVolumeSource_To_v1_AttachedVolumeSource(in *storage.AttachedVolumeSource, out *v1.AttachedVolumeSource, s conversion.Scope) error {
	return autoConvert_storage_AttachedVolumeSource_To_v1_AttachedVolumeSource(in, out, s)
}
...
func autoConvert_v1_VolumeAttachmentSpec_To_storage_VolumeAttachmentSpec(in *v1.VolumeAttachmentSpec, out *storage.VolumeAttachmentSpec, s conversion.Scope) error {
	...
	if err := Convert_v1_AttachedVolumeSource_To_storage_AttachedVolumeSource(&in.AttachedVolumeSource, &out.AttachedVolumeSource, s); err != nil {
		return err
	}
...
func autoConvert_storage_VolumeAttachmentSpec_To_v1_VolumeAttachmentSpec(in *storage.VolumeAttachmentSpec, out *v1.VolumeAttachmentSpec, s conversion.Scope) error {
	out.Attacher = in.Attacher
	if err := Convert_storage_AttachedVolumeSource_To_v1_AttachedVolumeSource(&in.AttachedVolumeSource, &out.AttachedVolumeSource, s); err != nil {
		return err
	}
	out.NodeName = in.NodeName
	return nil
