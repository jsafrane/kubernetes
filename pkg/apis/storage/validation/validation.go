...
func validateVolumeAttachmentSpec(
	...
	allErrs = append(allErrs, validateAttachedVolumeSource(&spec.AttachedVolumeSource, fldPath.Child("volumeSource"))...)
...
func validateAttachedVolumeSource(attachedVolumeSource *storage.AttachedVolumeSource, fldPath *field.Path) field.ErrorList {
	allErrs := field.ErrorList{}
	if attachedVolumeSource.PersistentVolumeName == nil || len(*attachedVolumeSource.PersistentVolumeName) == 0 {
