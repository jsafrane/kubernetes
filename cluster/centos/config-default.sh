...
export ADMISSION_CONTROL=${ADMISSION_CONTROL:-"Initializers,NamespaceLifecycle,LimitRanger,PersistentVolumeClaimResize,ServiceAccount,DefaultTolerationSeconds,Priority,ResourceQuota"}
